<?php
require_once($_SERVER['DOCUMENT_ROOT'].'/nexuscare/tools/permisos.php');
    ...
    <div class="sidebar-wrapper">
        ...
        <nav class="mt-2">
            ...
            <ul class="nav sidebar-menu flex-column"
                ...
                <li class="nav-item">
                    <a href="/nexuscare/?page=especialidades"
                ...
                <li class="nav-item">
                    <a href="/nexuscare/?page=serviciosMedicos"
                ...
                <li class="nav-item">
                    <a href="/nexuscare/?page=pacientes"
                ...
                <li class="nav-item">
                    <a href="/nexuscare/?page=reportes"
                ...
                <li class="nav-item">
                    <a href="/nexuscare/?page=usuarios"
