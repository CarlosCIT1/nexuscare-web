...
$fotoPerfil = "/nexuscare/uploads/perfiles/default.png";

if (
    isset($_SESSION['foto']) &&
    $_SESSION['foto'] != "" &&
    file_exists($_SERVER['DOCUMENT_ROOT']."/nexuscare/uploads/perfiles/".$_SESSION['foto'])
) {
    $fotoPerfil = "/nexuscare/uploads/perfiles/".$_SESSION['foto'];
}
...
<a href="/nexuscare/?page=contacto"
