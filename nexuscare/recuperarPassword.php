...
try {
    ...
    // Denegar recuperación de contraseña para pacientes: sólo personal autorizado
    if ($rol === 'paciente') {
        echo json_encode([
            "error"   => 1,
            "mensaje" => "Acceso denegado. Solamente personal autorizado puede recuperar contraseña."
        ]);
        exit;
    }
