...
$(document).ready(function () {
    ...
    $("#formRoles").off("submit").on("submit", function (e) {
        ...
        $.ajax({
            ...
            url: "/nexuscare/modulos/roles/rolesModelo.php?option=" + opcion,
...
function Modificar(id) {
    ...
    $.ajax({
        ...
        url: "/nexuscare/modulos/roles/rolesModelo.php?option=consultar&id=" + id,
...
function Eliminar(id) {
    ...
    swal({
        ...
        $.ajax({
            ...
            url: "/nexuscare/modulos/roles/rolesModelo.php?option=eliminar&id=" + id,
