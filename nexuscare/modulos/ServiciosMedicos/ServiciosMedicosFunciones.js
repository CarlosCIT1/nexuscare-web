...
$(document).ready(function () {
    ...
    $("#formServicio").off("submit").on("submit", function (e) {
        ...
        $.ajax({
            ...
            url: "/nexuscare/modulos/serviciosMedicos/serviciosMedicosModelo.php?option=" + opcion,
            ...
            success: function (r) {
                ...
                if (r.exito == 1) {
                    ...
                    swal(
                        ...
                        window.location.href = "/nexuscare/?page=serviciosMedicos";
...
function ModificarServicio(id) {
    ...
    $.ajax({
        ...
        url: "/nexuscare/modulos/serviciosMedicos/serviciosMedicosModelo.php?option=modificarConsultar&id=" + id,
    ...
    swal({
        ...
        if (ok) {
            ...
            $.ajax({
                ...
                url: "/nexuscare/modulos/serviciosMedicos/serviciosMedicosModelo.php?option=eliminar&id=" + id,
