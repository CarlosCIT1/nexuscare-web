...
function ModificarEspecialidad(id){
    ...
    $.ajax({
        ...
        url:"/nexuscare/modulos/especialidades/especialidadesModelo.php?option=consultar&id="+id,
        ...
        success:function(r){
            ...
            if(r.exito==1){
                ...
                if(r.imagen!=""){
                    ...
                    $("#previewImagen").attr(
                        "src",
                        "/nexuscare/uploads/categorias/"+r.imagen
                    );
...
$(document).off("submit", "#formEspecialidades").on("submit", "#formEspecialidades", function (e) {
    ...
    $.ajax({
        ...
        url: "/nexuscare/modulos/especialidades/especialidadesModelo.php?option=" + option,
    ...
    swal({
        ...
        if(ok){
            ...
            $.ajax({
                ...
                url:"/nexuscare/modulos/especialidades/especialidadesModelo.php?option=eliminar&id="+id,
