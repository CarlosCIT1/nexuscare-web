...
$(document).ready(function () {
    ...
    $("#formUsuarios").off("submit").on("submit", function (e) {
        ...
        $.ajax({
            ...
            url: "/nexuscare/modulos/usuarios/usuariosModelo.php?option=" + opcion,
                ...
                if (r.exito == 1) {
                    ...
                    if (r.cerrarSesion == 1) {
                        ...
                        swal({
                            ...
                            window.location.href = "/nexuscare/logout.php";
...
function Modificar(id) {
    ...
    $.ajax({
        ...
        url: "/nexuscare/modulos/usuarios/usuariosModelo.php?option=modificarConsultar&id=" + id,
    ...
    swal({
        ...
        if (ok) {
            ...
            $.ajax({
                ...
                url: "/nexuscare/modulos/usuarios/usuariosModelo.php?option=eliminar&id=" + id,
