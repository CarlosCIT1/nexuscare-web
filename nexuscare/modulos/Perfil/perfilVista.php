...
if(!isset($_SESSION['id'])){
    header("Location: /nexuscare/login.php");
    exit;
}
...
if(
    !empty($usuario["foto"]) &&
    file_exists($_SERVER['DOCUMENT_ROOT']."/nexuscare/uploads/perfiles/".$usuario["foto"])
){
    $foto = $usuario["foto"];
}
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    <div class="text-center mb-4">
                        ...
                        <img
                            id="previewFoto"
                            src="/nexuscare/uploads/perfiles/<?php echo $foto; ?>"
