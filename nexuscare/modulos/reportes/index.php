            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php include_once($_SERVER['DOCUMENT_ROOT'].'/nexuscare/modulos/reportes/reportesTabla.php'); ?>
                        </div>
...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/nexuscare/tools/footer.php'); ?>

<?php include_once($_SERVER['DOCUMENT_ROOT'].'/nexuscare/modulos/reportes/reportesModal.php'); ?>

<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
<script src="/nexuscare/modulos/reportes/reportesFunciones.js"></script>