...
$(document).ready(function () {
    ...
    $("#formReporte").on("submit", function (e) {
        ...
        $.ajax({
            url: "/nexuscare/modulos/reportes/reportesModelo.php?option=" + opcion,
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
...
function ModificarReporte(id) {
    ...
    $.ajax({
        url: "/nexuscare/modulos/reportes/reportesModelo.php?option=consultar&id=" + id,
        type: "GET",
        dataType: "json",
...
function CompletarReporte(id) {
    ...
    .then((ok) => {
        if (ok) {
            ...
            $.ajax({
                url: "/nexuscare/modulos/reportes/reportesModelo.php?option=completar&id=" + id,
                type: "POST",
                dataType: "json",
