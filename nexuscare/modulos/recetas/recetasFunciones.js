...
$(document).ready(function () {
    ...
    $("#formReceta").off("submit").on("submit", function (e) {
        ...
        $.ajax({
            url: "/nexuscare/modulos/recetas/recetasModelo.php?option=" + opcion,
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
...
function ModificarReceta(id) {
    ...
    $.ajax({
        url: "/nexuscare/modulos/recetas/recetasModelo.php?option=consultar&id=" + id,
        type: "GET",
        dataType: "json",
...
function EliminarReceta(id) {
    swal({
        ...
        if (ok) {
            $.ajax({
                url: "/nexuscare/modulos/recetas/recetasModelo.php?option=eliminar&id=" + id,
                type: "POST",
                dataType: "json",
