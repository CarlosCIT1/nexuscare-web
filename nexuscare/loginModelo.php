...
");
    ...
    // Denegar acceso a la interfaz web para usuarios con rol 'Paciente'
    $rolNombreLower = strtolower(trim((string)$rol['nombre'] ?? ''));
    if ($rolNombreLower === 'paciente') {
        echo json_encode([
            "exito" => 0,
            "mensaje" => "Acceso denegado. Solamente puede iniciar sesión personal autorizado"
        ]);
        exit;
    }
